...
# Required Data
For my code to execute properly, you must have the data folder in your working directory. The only additional step before you can begin running the code is to download the V-Dem data from [https://v-dem.net/data/the-v-dem-dataset/country-year-v-dem-fullothers-v15/](this link).
